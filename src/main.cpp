...
// AES key — non-const, loaded from NVS or generated by key manager
// AES key loaded from secrets.h — never commit real keys to public repos
#include "secrets.h"
uint8_t AES_KEY[32];  // populated in setup() from SECRETS_AES_KEY
